...
//! Project version number for LSUniversalSDK.
FOUNDATION_EXPORT double LSUniversalSDKVersionNumber;

//! Project version string for LSUniversalSDK.
FOUNDATION_EXPORT const unsigned char LSUniversalSDKVersionString[];
